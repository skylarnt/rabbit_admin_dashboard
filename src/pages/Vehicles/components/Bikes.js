        ...
        <>
                        ...
                        <div className="d-md-flex justify-content-between" >
                            <div className="pb-3 pb-md-0">
                                ...
                                <small style={{ fontWeight: '200', fontSize: '14px' }}>
                                    These are all your Buses with their assigned Rider
                                </small>
                                    ...
                                    <tr className={`${styles.tr} `}>
                                        ...
                                        <td>
                                            <p className="mb-0 text-danger" style={{ fontSize: '14px', textDecoration: 'underline' }}>
                                                <span className=" text-danger" href="#" onClick={() => setassignRider(true)} style={{ cursor: 'pointer' }}>
                                                    Assign Rider
                                                </span>
                                            </p>
                                        </td>
            ...
            >
                ...
                >
                    <div className={`modal_header mb-0`}>
                        ...
                        <span onClick={handleCloseAssignRider} style={{ cursor: 'pointer' }}>
                    ...
                    <div className="mt-3 mb-2">
                        <label htmlFor="Riders">Available Riders</label>
                        <Select
                            labelId="s"
                            id="s"
                            fullWidth
                        ...
                        >
                            ...
                            <MenuItem value='select'>Select Rider</MenuItem>
                    ...
                    <div className="d-block w-100 mt-3"><button className="d-block w-100 btn py-2 text-white" onClick={handleCloseAssignRider} style={{ background: '#00AF52' }}>Assign</button></div>
            ...
            >
                <div className={`${styles.modal_content}`}>
                    ...
                    <p className="text-dark mt-4" style={{ fontSize: '16px', fontWeight: '500' }}>Assigned Rider</p>
                        ...
                        <div className="row mt-3">
                            <div className="col-6 mb-1">
                                <div className="mb-3">
                                    ...
                                    <div className="mt-3 mb-2">
                                        <label htmlFor="drivers">Select New Rider</label>
                                        <Select
                                            labelId="s"
                                            id="s"
                                            fullWidth
                            ...
                            <div className="col-6 mb-1">
                                <div className="mb-3">
                                    ...
                                    <p><small className="m-0 text-muted font-weight-normal">Qlink Legend 250</small></p>
                                </div>
