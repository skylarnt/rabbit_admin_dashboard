...
import NotificationsPopover from '../../../src/layouts/dashboard/header/NotificationsPopover.js';
  ...
  return (
    <>
      ...
      <div className='wrapper mt-md-3 mt-4'>
        <StyledRoot className='header_container style_cs mt-5'>
        ...
        >
          ...
          <div className="dropleft ">
            ...
            <div className="dropdown-menu drop-left" aria-labelledby="dropdownMenuButton">
              <button type="button" className="rss dropdown-item btn border-0">Logout</button>
